...
<html lang="es">
<head>    
    <meta name="description" content="The SounDLibrary" />    
    <meta name="author" content="Isaac Rovira" />    
			...
			<div class="col-xs-12 col-sm-10 " id="contenido">
				<div class="row">
					<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
						<figure>
							<img src="./img/Caratulas/ACME.jpg" alt="ACME" class="img-fluid img-thumbnail">
